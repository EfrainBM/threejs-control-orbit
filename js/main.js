...
function init() {
    ...
    scene.fog = new THREE.FogExp2(0x6f2a60, 0.0015);
    console.log(scene);
    ...
    const geometry = new THREE.ConeGeometry(10, 50, 1000, 2.5);
    ...
    const dirLight1 = new THREE.DirectionalLight(0x15ff02, 3);
    ...
    const ambientLight = new THREE.AmbientLight(0x5400645);
